...
Append-only. One entry per settled decision; date, decision, one-line why.
Corpus/licensing/labeling-signal background: docs/dataset-notes.md.
...
**D13 · 2026-07-18 · Labeler acceptance (pre-registered): book-2 recall
